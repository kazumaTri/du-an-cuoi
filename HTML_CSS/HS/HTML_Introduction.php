...
<html lang="en">
  ...
  <body>
    ...
    >
      <div class="container">
        <h1 class="display-4 custom-title">Giới thiệu HTML</h1>
      </div>
    </header>

    <div class="container mt-5" style="margin-left: 220px">
      <div class="content-section">
        <h2 class="mb-4">Learning Path Overview</h2>
        <p>
          HTML (HyperText Markup Language) là ngôn ngữ đánh dấu được sử dụng để
          tạo và cấu trúc nội dung trên web. HTML cho phép bạn xác định các phần
          tử như tiêu đề, đoạn văn, hình ảnh, liên kết và nhiều thành phần khác
          của một trang web.
        </p>
      </div>
    </div>
