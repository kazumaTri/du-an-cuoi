...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_SESSION['ma_nguoi_dung']) && isset($_POST['ma_bai_hoc']) && isset($_POST['noidung'])) {
        ...
        $sql = "INSERT INTO Binh_Luan (Ma_nguoi_dung, Ma_bai_hoc, Noi_dung) VALUES (?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("iis", $ma_nguoi_dung, $ma_bai_hoc, $noi_dung);

        if ($stmt->execute()) {
            // Chuyển hướng lại trang để hiển thị bình luận mới
...
<body>
    ...
    <header class="bg-light py-5 shadow-sm">
      <div class="container text-center">
        <h1 class="display-3 mb-3 text-primary">Chào Mừng đến với CSS</h1>
      ...
      <div class="row mt-4">
        <div class="col-md-4 mb-4">
          <div class="card shadow-sm">
            <img src="../img/CSS.jpg" class="card-img-top" alt="Bài Học CSS" />
            <div class="card-body">
              <h5 class="card-title">Bài Học CSS</h5>
              <p class="card-text">Khám phá các kỹ thuật CSS để tạo kiểu cho trang web của bạn.</p>
              <a href="CSS_Introduction.html" class="btn btn-primary">Xem chi tiết</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="card shadow-sm">
            <img src="../img/CSS.jpg" class="card-img-top" alt="Bài Học HTML" />
            <div class="card-body">
              <h5 class="card-title">Bài Học HTML</h5>
              <p class="card-text">Tìm hiểu về cấu trúc của các trang web với HTML.</p>
              <a href="HTML.php" class="btn btn-primary">Xem chi tiết</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="card shadow-sm">
            <img src="../img/CSS.jpg" class="card-img-top" alt="Bài Học Bootstrap" />
            <div class="card-body">
              <h5 class="card-title">Bài Học Bootstrap</h5>
              <p class="card-text">Học cách sử dụng Bootstrap để thiết kế trang web responsive.</p>
    ...
    <div class="container mt-4">
        ...
        <form action="" method="POST">
            ...
            <input type="hidden" name="ma_bai_hoc" value="2"> <!-- Thay đổi giá trị này theo bài học hiện tại -->
    ...
    <div class="container mt-4">
        ...
        <div id="comments-section">
            <?php
            // Hiển thị bình luận
            $ma_bai_hoc = 2; // Thay đổi giá trị này theo bài học hiện tại
...
const danhSachBaiHoc = [
    ...
    {ten:"Bài Học CSS", link: "CSS_Introduction.php"}
